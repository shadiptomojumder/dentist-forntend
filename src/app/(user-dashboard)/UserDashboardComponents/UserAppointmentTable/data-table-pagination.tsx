import DeleteMultipleAppointment from "@/api/appointment/deleteMultipleAppointment";
          ...
          {table.getFilteredSelectedRowModel().rows.length > 0 && (
            <AlertDialog open={isDeleteDialogOpen}>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel onClick={setIsDeleteDialogOpen.bind(null, false)}>Cancel</AlertDialogCancel>
                  <AlertDialogAction onClick={handleMultipleDelete} disabled={isPending} className="hover:bg-primary">
